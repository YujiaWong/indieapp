  ...
  return (
    ...
    >
      ...
      {editingId === item.id ? (
        ...
        <div className='flex-1 cursor-pointer py-1' onClick={() => onEdit(item.id, item.description)}>
...
export default forwardRef((props: any, ref: any) => {
  ...
  const handleDragEnd = (event: any) => {
    ...
    if (active?.id !== over?.id) {
      const oldIndex = funcList.findIndex((item: any) => item.id === active?.id);
    ...
    <div className='w-[85%] py-6 border-t border-gray-100 mx-auto relative flex flex-col'>
      {showSkeleton ? (
        ...
        <>
          ...
          <div className='mt-10 mb-3 px-6'>Have more thoughts? Add them below</div>
